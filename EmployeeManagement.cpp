...
void Record_Employee(int opt)
{
    ...
    case 3:
    {
        ...
        cout << "=========================================================================================================================================================" << endl;
        cout << "|                               |              |                           |            |                 |                                             |"<< endl;
        cout << "|                 Employee_Name |        EmpID |                      Role |     Sector |     Mobile no.  |                               Email Address |" << endl;
        cout << "|                               |              |                           |            |                 |                                             |"<< endl;
        while(getline(emp, employeeRecord))
        {
            cout << "|-------------------------------+--------------+---------------------------+------------+-----------------+---------------------------------------------|"<< endl;
            
            stringstream stst(employeeRecord);
            stst >> empdata[0] >> empdata[1]>> empdata[2]>> empdata[3]>> empdata[4]>> empdata[5];
            cout << "|"<<setw(30) <<empdata[0]<< " | " << setw(13)<<  empdata[1] << "| " << setw(25) << empdata[2] << " | "<<setw(10) <<  empdata[3] << " | "<<setw(15)<< empdata[4] <<" | "<<setw(40)<<  empdata[5] << "    |"<<endl;;
        }
        cout << "=========================================================================================================================================================" << endl;
        cout << "=========================================================================================================================================================" << endl;
